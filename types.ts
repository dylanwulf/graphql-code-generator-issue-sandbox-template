...
export type ResolversInterfaceTypes<_RefType extends Record<string, unknown>> = {
  Item: ( Omit<Package, 'components'> & { components: Array<_RefType['PackageComponent']> } ) | ( Product );
};

/** Mapping between all available schema types and the resolvers types */
export type ResolversTypes = {
  Boolean: ResolverTypeWrapper<Scalars['Boolean']['output']>;
  Cart: ResolverTypeWrapper<Omit<Cart, 'fulfillments'> & { fulfillments: Array<ResolversTypes['CartFulfillment']> }>;
  CartFulfillment: ResolverTypeWrapper<Omit<CartFulfillment, 'lines'> & { lines: Array<ResolversTypes['CartLine']> }>;
  CartLine: ResolverTypeWrapper<Omit<CartLine, 'item'> & { item: ResolversTypes['Item'] }>;
  ID: ResolverTypeWrapper<Scalars['ID']['output']>;
  Int: ResolverTypeWrapper<Scalars['Int']['output']>;
  Item: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['Item']>;
  Package: ResolverTypeWrapper<Omit<Package, 'components'> & { components: Array<ResolversTypes['PackageComponent']> }>;
  PackageComponent: ResolverTypeWrapper<Omit<PackageComponent, 'item'> & { item: ResolversTypes['Item'] }>;
...
export type ResolversParentTypes = {
  ...
  Cart: Omit<Cart, 'fulfillments'> & { fulfillments: Array<ResolversParentTypes['CartFulfillment']> };
  CartFulfillment: Omit<CartFulfillment, 'lines'> & { lines: Array<ResolversParentTypes['CartLine']> };
  CartLine: Omit<CartLine, 'item'> & { item: ResolversParentTypes['Item'] };
  ID: Scalars['ID']['output'];
  Int: Scalars['Int']['output'];
  Item: ResolversInterfaceTypes<ResolversParentTypes>['Item'];
  Package: Omit<Package, 'components'> & { components: Array<ResolversParentTypes['PackageComponent']> };
  PackageComponent: Omit<PackageComponent, 'item'> & { item: ResolversParentTypes['Item'] };
  Product: Product;
  Query: {};
